...
for step in iterador_plot:    
    ...
    start, end, binwidth = 0, max(array), 1
    aux_args = {
        'data': array,
        'kde': True,
        'stat': 'density',
...
bar_year(fig_bar_mpl, ax_bar_mpl, '../figuras/ex01-b-evolucion_temporal.pdf')
#%%
...
bar_year(fig, ax, '../figuras/ex01-b-ultima_iteracion.pdf')